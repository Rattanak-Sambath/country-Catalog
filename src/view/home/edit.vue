    ...
    <q-card class="flex justify-space-between">
      ...
      <q-toolbar>
        <q-toolbar-title class="text-h6 text-bold"
          ><q-icon name="add"></q-icon> Edit Staff</q-toolbar-title
        >
        <q-space />
                ...
                <div class="row q-col-gutter-y-md">
                  ...
                  <div class="col-12">
                    ...
                    >
                      ...
                      >
                        <template v-slot:prepend>
                          <q-icon name="phone" color="indigo-10" />
                        </template>
                      </q-input>
                    </validate-field>
                  </div>
                  <div class="col-12">
                    ...
                    >
                      ...
                      >
                        <template v-slot:prepend>
                          <q-icon name="picture_in_picture" color="indigo-10" />
                        </template>
                      </q-select>
                    </validate-field>
                  </div>
                ...
                <div class="row q-col-gutter-y-md">
                  ...
                  <div class="col-12">
                    ...
                    >
                      ...
                      >
                        <template v-slot:prepend>
                          <q-icon name="money" color="indigo-10" />
                        </template>
                      </q-input>
                    </validate-field>
                  </div>
                  <div class="col-12">
                    ...
                    >
                      ...
                      >
                        <template v-slot:prepend>
                          <q-icon name="transgender" color="indigo-10" />
                        </template>
                      </q-select>
                    </validate-field>
                  </div>
                  <div class="col-12">
                    ...
                    >
                      ...
                      >
                        <template v-slot:prepend>
                          <q-icon name="place" color="indigo-10" />
                        </template>
                      </q-input>
                    </validate-field>
                  </div>
...
const onUpdate = async () => {
  ...
  if (valid) {
    ...
    if (res) {
      toast.success({ message: "Update staff successfully" });
      cancel();
    } else {
